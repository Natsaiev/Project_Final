...
export const eventsList = document.querySelector(".events_container"); 
export const selectTypeEvent = document.querySelector("#typeEventMenu");
export const selectDistanceEvent = document.querySelector("#distanceEventMenu");
export const selectCategoryEvent = document.querySelector("#selectCategoryEvent");
export const eventsFiltersContainer = document.querySelector(".filters_container");